...
def RelativePath(path, relative_to, follow_path_symlink=True):
    ...
    path = os.path.realpath(path) if follow_path_symlink else os.path.abspath(
        path)
    ...
    relative_split = [os.path.pardir] * (len(relative_to_split) -
                                         prefix_len) + path_split[prefix_len:]
...
def CrossCompileRequested():
    ...
    return (os.environ.get("GYP_CROSSCOMPILE") or os.environ.get("AR_host")
            or os.environ.get("CC_host") or os.environ.get("CXX_host")
            or os.environ.get("AR_target") or os.environ.get("CC_target")
