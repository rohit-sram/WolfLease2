...
class _Enumeration(_Type):
  ...
  """
    ...
    def __init__(self, label_list, new=None):
        ...
        self._msbuild_values = {
            value
            for value in label_list if value is not None
        }
        if new is not None:
...
def _Renamed(tool, msvs_name, msbuild_name, setting_type):
  ...
  """
    ...
    _msbuild_validators[
        tool.msbuild_name][msbuild_name] = setting_type.ValidateMSBuild
...
def _MovedAndRenamed(tool, msvs_settings_name, msbuild_tool_name,
  ...
  """
    ...
    _msvs_validators[
        tool.msvs_name][msvs_settings_name] = setting_type.ValidateMSVS
    validator = setting_type.ValidateMSBuild
    _msbuild_validators[msbuild_tool_name][msbuild_settings_name] = validator
    _msvs_to_msbuild_converters[
        tool.msvs_name][msvs_settings_name] = _Translate
    ...
    def _Translate(value, msbuild_settings):
        if value == "true":
            ...
            if "AdditionalOptions" in tool_settings:
                new_flags = "{} {}".format(tool_settings["AdditionalOptions"],
                                           flag)
            else:
                new_flags = flag
...
def _CustomGeneratePreprocessedFile(tool, msvs_name):
    ...
    msbuild_tool_validators[
        "PreprocessSuppressLineNumbers"] = msbuild_validator
    _msvs_to_msbuild_converters[tool.msvs_name][msvs_name] = _Translate
...
_Same(
    _compile,
    "CallingConvention",
    _Enumeration(["Cdecl", "FastCall", "StdCall",
                  "VectorCall"]),  # /Gd  # /Gr  # /Gz
)  # /Gv
_Same(
    _compile,
...
_Same(
    _compile,
    "ExceptionHandling",
    _Enumeration(["false", "Sync", "Async"],
                 new=["SyncCThrow"]),  # /EHsc  # /EHa
)  # /EHs
_Same(
    _compile,
    "FavorSizeOrSpeed",
...
_Same(
    _compile,
    "Optimization",
    _Enumeration(["Disabled", "MinSpace", "MaxSpeed",
                  "Full"]),  # /Od  # /O1  # /O2
)  # /Ox
_Same(
    _compile,
...
_Renamed(
    ...
    "PrecompiledHeader",
    _Enumeration(["NotUsing", "Create",
                  "Use"]  # VS recognized '' for this value too.  # /Yc
                 ),
)  # /Yu
...
_MSBuildOnly(_compile, "CompileAsManaged",
             _Enumeration([], new=["false", "true"]))  # /clr
...
_Same(
    _link,
    "Driver",
    _Enumeration(["NotSet", "Driver", "UpOnly",
                  "WDM"]),  # /Driver  # /DRIVER:UPONLY
)  # /DRIVER:WDM
_Same(
    _link,
...
_Same(
    ...
    "ShowProgress",
    _Enumeration(
        ["NotSet", "LinkVerbose", "LinkVerboseLib"
         ],  # /VERBOSE  # /VERBOSE:Lib
        new=[
...
_Same(
    _midl,
    "DefaultCharType",
    _Enumeration(["Unsigned", "Signed",
                  "Ascii"]),  # /char unsigned  # /char signed
)  # /char ascii7
_Same(
    _midl,
    "TargetEnvironment",
