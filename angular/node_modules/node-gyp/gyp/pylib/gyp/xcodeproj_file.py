...
class XCObject:
  ...
  """
    ...
    """
        ...
        if "name" in self._properties or ("name" in self._schema
                                          and self._schema["name"][3]):
    ...
    """
      ...
      """
        ...
        if overwrite or self.id is None:
            ...
            digest_ints = struct.unpack(">" + "I" * digest_int_count,
                                        hash.digest())
            id_ints = [0, 0, 0]
    ...
    """
        ...
        if isinstance(value, XCObject):
            ...
            if flatten_list and len(value) <= 1:
                ...
                printable = "(" + sep
                for item in value:
                    printable += (element_tabs + self._XCPrintableValue(
                        tabs + 1, item, flatten_list) + "," + sep)
                printable += end_tabs + ")"
        elif isinstance(value, dict):
            printable = "{" + sep
            ...
            raise TypeError("Can't make " + value.__class__.__name__ +
                            " printable")
    ...
    """
        ...
        if key == "remoteGlobalIDString" and isinstance(
                self, PBXContainerItemProxy):
        ...
        try:
            ...
            printable_value = self._XCPrintableValue(tabs, value_to_print,
                                                     flatten_list)
            if (strip_value_quotes and len(printable_value) > 1
        ...
        for property, value in properties.items():
            ...
            if is_list:
                if value.__class__ != list:
                    raise TypeError(property + " of " +
                                    self.__class__.__name__ +
                                    " must be list, not " +
                                    value.__class__.__name__)
                for item in value:
                    if not isinstance(item, property_type) and not (isinstance(
                            item, str) and property_type == str):
                        # Accept unicode where str is specified.  str is treated as
                        # UTF-8-encoded.
                        raise TypeError("item of " + property + " of " +
                                        self.__class__.__name__ + " must be " +
                                        property_type.__name__ + ", not " +
                                        item.__class__.__name__)
            elif not isinstance(value, property_type) and not (isinstance(
                    value, str) and property_type == str):
                # Accept unicode where str is specified.  str is treated as
                # UTF-8-encoded.
                raise TypeError(property + " of " + self.__class__.__name__ +
                                " must be " + property_type.__name__ +
                                ", not " + value.__class__.__name__)
    ...
    def AppendProperty(self, key, value):
        ...
        if not is_list:
            raise TypeError(key + " of " + self.__class__.__name__ +
                            " must be list")
        if not isinstance(value, property_type):
            raise TypeError("item of " + key + " of " +
                            self.__class__.__name__ + " must be " +
                            property_type.__name__ + ", not " +
                            value.__class__.__name__)
    ...
    """
        ...
        for property, attributes in self._schema.items():
            ...
            if is_required and property not in self._properties:
                raise KeyError(self.__class__.__name__ + " requires " +
                               property)
  ...
  project file."""
    ...
    def __init__(self, properties=None, id=None, parent=None):
        ...
        if "path" in self._properties and ("sourceTree" not in self._properties
            ...
            (source_tree,
             path) = SourceTreeAndPathFromPath(self._properties["path"])
            if source_tree is not None:
                self._properties["sourceTree"] = source_tree
            if path is not None:
                self._properties["path"] = path
            if (source_tree is not None and path is None
  ...
  """
    ...
    def _AddChildToDicts(self, child):
        ...
        if child_path:
            if child_path in self._children_by_path:
                raise ValueError("Found multiple children with path " +
                                 child_path)
        ...
        if isinstance(child, PBXVariantGroup):
            ...
            if key in self._variant_children_by_name_and_path:
                raise ValueError(
                    "Found multiple PBXVariantGroup children with " + "name " +
                    str(child_name) + " and path " + str(child_path))
    ...
    def GetChildByRemoteObject(self, remote_object):
        ...
        for child in self._properties["children"]:
            ...
            if container_proxy._properties[
                    "remoteGlobalIDString"] == remote_object:
                return child
    ...
    """
        ...
        if (len(path_split) == 1 or
            ((is_dir or variant_name is not None) and len(path_split) == 2)
                or not hierarchical):
    ...
    """
        ...
        while (len(self._properties["children"]) == 1
            ...
            if ("sourceTree" not in self._properties
                ...
                if "sourceTree" in old_properties:
                    ...
                    self._properties["sourceTree"] = old_properties[
                        "sourceTree"]
            ...
            if ("name" in self._properties and "path" in self._properties
...
class XCConfigurationList(XCObject):
    ...
    def DefaultConfiguration(self):
        ...
        return self.ConfigurationNamed(
            self._properties["defaultConfigurationName"])
...
class XCBuildPhase(XCObject):
  ...
  """
    ...
    """
        ...
        # problem.
        if (xcfilelikeelement in self._files_by_xcfilelikeelement
                and self._files_by_xcfilelikeelement[xcfilelikeelement]
                != pbxbuildfile):
            ...
            if path_tree in self.path_tree_first_to_subfolder:
                ...
                if subfolder == 16 and path_tree_match.group(4) is not None:
                    ...
                    if path_tree in self.path_tree_second_to_subfolder:
                        subfolder = self.path_tree_second_to_subfolder[
                            path_tree]
                        if relative_path is None:
                            relative_path = ""
                            separator = ""
...
class PBXContainerItemProxy(XCObject):
    ...
    def __repr__(self):
        ...
        name = "{}.gyp:{}".format(props["containerPortal"].Name(),
                                  props["remoteInfo"])
        return f"<{self.__class__.__name__} {name!r} at 0x{id(self):x}>"
...
class PBXTargetDependency(XCObject):
    ...
    def __repr__(self):
        name = self._properties.get(
            "name") or self._properties["target"].Name()
        return f"<{self.__class__.__name__} {name!r} at 0x{id(self):x}>"
...
class XCTarget(XCRemoteObject):
    ...
    def AddDependency(self, other):
        ...
        if pbxproject == other_pbxproject:
            ...
            other_project_ref = pbxproject.AddOrGetProjectReference(
                other_pbxproject)[1]
            container = PBXContainerItemProxy({
    ...
    def ConfigurationNamed(self, name):
        return self._properties["buildConfigurationList"].ConfigurationNamed(
            name)
    ...
    def SetBuildSetting(self, key, value):
        return self._properties["buildConfigurationList"].SetBuildSetting(
            key, value)

    def AppendBuildSetting(self, key, value):
        return self._properties["buildConfigurationList"].AppendBuildSetting(
            key, value)
...
class PBXNativeTarget(XCTarget):
    ...
    _product_filetypes = {
        ...
        ["wrapper.cfbundle", "", ".xctest"],
        "com.apple.product-type.bundle.ui-testing":
        ["wrapper.cfbundle", "", ".xctest"],
        "com.googlecode.gyp.xcode.bundle":
        ["compiled.mach-o.dylib", "", ".so"],
    ...
    def __init__(
        ...
        if ("productName" in self._properties
                ...
                and "productReference" not in self._properties and
            ...
            if products_group is not None:
                ...
                if force_extension is not None:
                    ...
                    if filetype.startswith("wrapper."):
                        self.SetBuildSetting("WRAPPER_EXTENSION",
                                             force_extension)
                    else:
                        self.SetBuildSetting("EXECUTABLE_EXTENSION",
                                             force_extension)
...
class PBXProject(XCContainerPortal):
  ...
  """
    ...
    """
        ...
        self._SetUpProductReferences(other_pbxproject, product_group,
                                     project_ref)
        ...
        if all(
                self._AllSymrootsUnique(t, inherit_unique_symroot)
                for t in targets):
        ...
        for target in other_pbxproject._properties["targets"]:
            ...
            if product_group.GetChildByRemoteObject(other_fileref) is None:
                ...
                reference_proxy = PBXReferenceProxy({
                    "fileType":
                    other_fileref._properties["explicitFileType"],
                    "path":
                    other_fileref._properties["path"],
                    "sourceTree":
                    other_fileref._properties["sourceTree"],
                    "remoteRef":
                    container_item,
                })
    ...
    def SortRemoteProductReferences(self):
        ...
        def CompareProducts(x, y, remote_products):
            ...
            x_remote = x._properties["remoteRef"]._properties[
                "remoteGlobalIDString"]
            y_remote = y._properties["remoteRef"]._properties[
                "remoteGlobalIDString"]
        ...
        for other_pbxproject, ref_dict in self._other_pbxprojects.items():
            ...
            product_group._properties["children"] = sorted(
                ...
                key=cmp_to_key(lambda x, y, rp=remote_products:
                               CompareProducts(x, y, rp)),
            )
...
class XCProjectFile(XCObject):
    ...
    def ComputeIDs(self, recursive=True, overwrite=True, hash=None):
        ...
        if recursive:
            self._properties["rootObject"].ComputeIDs(recursive, overwrite,
                                                      hash)
